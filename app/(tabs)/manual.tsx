  ...
  return (
    <FadeInView style={styles.screen}>
      <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
        ...
        <Card>
          <View style={styles.chip}><MaterialCommunityIcons name="lightning-bolt" size={14} color={colors.primary} /><Text style={styles.chipText}>Rápido y preciso</Text></View>
...
const createStyles = (colors: any, typography: any) => StyleSheet.create({
  ...
  chip: { flexDirection: 'row', alignSelf: 'flex-start', alignItems: 'center', gap: spacing.xs, paddingHorizontal: spacing.sm, paddingVertical: 6, borderRadius: radius.pill, backgroundColor: colors.backgroundSoft },
  chipText: { ...typography.caption, color: colors.primary },
  label: { ...typography.caption, marginTop: spacing.xs, color: colors.textSecondary },
  resultCard: { backgroundColor: colors.surfaceElevated },
